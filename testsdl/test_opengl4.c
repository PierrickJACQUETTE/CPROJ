...
void test(){   glBegin( GL_TRIANGLES );            /* Drawing Using Triangles */
    ...
    glBegin(GL_POLYGON);//begin drawing of polygon
      glVertex2f(-0.2,0.2);//first vertex
      glVertex2f(0.2,0.2);//second vertex
      glVertex2f(0.7,0.0);//third vertex
      glVertex2f(0.2,-0.2);//fourth vertex
      glVertex2f(-0.2,-0.2);//fifth vertex
      glVertex2f(-0.7,0.0);//sixth vertex
    glEnd();//end drawing of polygon

	glLoadIdentity();
	glColor3ub(0, 255, 255); // on demande du bleu
    glBegin(GL_POLYGON);//begin drawing of polygon
      glVertex2f(-0.2,0.2);//first vertex
      glVertex2f(0.2,0.2);//second vertex
      glVertex2f(0.7,0.0);//third vertex
