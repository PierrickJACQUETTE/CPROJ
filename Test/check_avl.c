...
START_TEST(initAvlNOTNULL){
	...
	Node *n = initNode(1,1.0,2.0,"true",NULL);
	init(&avl,n, NULL);
	Node *n2 = initNode(12,1.0,2.0,"true",NULL);
...
START_TEST(insertAvlNode){
	Avl *aNode = NULL;
	Node *n = initNode(2,1.0,2.0,"true",NULL);
	init(&aNode ,n, NULL);

	Node *n2 = initNode(3,1.0,2.0,"true",NULL);
	insert(&aNode,n2,NULL);
	ck_assert_ptr_eq(aNode->right->node,n2);
	n2 = initNode(1,1.0,2.0,"true",NULL);
	insert(&aNode,n2,NULL);
	ck_assert_ptr_eq(aNode->left->node,n2);
	n2 = initNode(4,1.0,2.0,"true",NULL);
	insert(&aNode,n2,NULL);
...
START_TEST(insertAvlNodeIdYes){
	...
	insert(&aNode,n2,NULL);
	ck_assert_ptr_eq(aNode->right->node,n2);
	n2 = initNode(3,1.0,2.0,"true",NULL);
...
START_TEST(searchNodeAvlYes){
	...
	Node *n2 = initNode(1,1.0,2.0,"true",NULL);
	insert(&aNode,n2,NULL);
	ck_assert_ptr_eq(aNode->left->node,n2);
	n2 = initNode(3,1.0,2.0,"true",NULL);
	insert(&aNode,n2,NULL);
...
START_TEST(searchNodeAvlNo){
	...
	insert(&aNode,n2,NULL);
	ck_assert_ptr_eq(aNode->left->node,n2);
	Node *n3 = initNode(3,1.0,2.0,"true",NULL);
