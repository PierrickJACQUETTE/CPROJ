...
* @param  refX     int The reference point x
* @param  refY     int The reference point y
* @param  decalage float The current decalage
* @param  flag     int Whether one or +zoom -zoom
* @return          float The new decalage
*/
